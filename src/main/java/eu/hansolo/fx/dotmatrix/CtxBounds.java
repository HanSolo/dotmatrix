...
public class CtxBounds {
    ...
    public void setWidth(final double WIDTH) { width = DotMatrix.clamp(0, Double.MAX_VALUE, WIDTH); }

    public double getHeight() { return height; }
    public void setHeight(final double HEIGHT) { height = DotMatrix.clamp(0, Double.MAX_VALUE, HEIGHT); }
}
